        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
           <li><a href="../index.php"><b>Visit Web Site</b></a></li>
             <li><a href="registers_inquiry.php" ><b>Users</b></a></li>
              <li class="active"><a href="contact_us_inquiry.php" ><b>Contact Inquiry</b></a></li>
          </ul>
        </div>
      </nav>
    </div>
...
<?php
                $sql_getRegisterDetails = "SELECT * FROM contact_us";
