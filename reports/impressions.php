          ...
          <!--mycontent-->
            ...
            $('#datepairExample .date').datepicker({
              ...
              <table width="100%" align='center' cellpadding="4" cellspacing='1' class="purple" id="table-1" colspacing='0'>
                ...
                <?php
//         grp cdate country
		 $sql_getImpressionsData = "SELECT date,SUM(total_imp) AS total_imp,type_size,cpm_rate,SUM(value)/1000 AS value FROM impressions WHERE 1=1 ";;
              
                    if(($_POST['from_date']) && ($_POST['to_date']))
                    {
//                        echo "From: ".$_POST['from_date']."To:".$_POST['to_date']."<br />";
                        $sql_getImpressionsData .= " AND date BETWEEN '".$_POST['from_date']."' AND '".$_POST['to_date']."'";
...
//                        $sql_getImpressionsData .= " AND YEAR(date)='".$_POST['drp_year']."'";
                ...
                $sql_getImpressionsData .=  " GROUP BY date ";
                $sql_getImpressionsData .=  " ORDER BY date,country";
		...
		$result_impressionsData = mysql_query($sql_getImpressionsData,$con);
		 ...
		 $int_loopId = 1;
                ...
                <tr style="text-align: center;height: 30px;">
                  ...
                  <td><?php echo $arr_impressionsData['date']; ?></td>
                  <td><?php echo $arr_impressionsData['type_size']; ?></td>
                 
                  
                  <td align="center"><?php echo number_format($arr_impressionsData['total_imp']); ?></td>
                  <td align="center"><?php echo $arr_impressionsData['cpm_rate']; ?></td>
                  <td align="center"><?php echo number_format($arr_impressionsData['value']); ?></td>
                </tr>
                <?php
